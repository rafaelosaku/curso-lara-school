...
<html>
	...
	<body>
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="navbar-header">
		      ...
		      <a class="navbar-brand" href="#">
		      	<img src="{{asset('assets/imgs/logo-laraschool.png')}}" alt="LaraSchool" class="logo">
		      </a>
		    </div>
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="navbar-nav menu-itens">
		        ...
		        <li class="dropdown">
		          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Instrutor <span class="caret"></span></a>
		...
		<footer class="footer">
			<div class="container">
				<div class="col-md-6">
					<img src="{{asset('assets/imgs/logo-laraschool-two.png')}}" alt="LaraSchool" class="logo-footer">
				</div>
